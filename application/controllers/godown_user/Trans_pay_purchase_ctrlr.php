...
class Trans_pay_purchase_ctrlr extends CI_Controller {

    public function index() {
        $data['title'] = 'Payment Purchase';
        ...
        $data['main_content'] = 'godown_user/trans_pay_purchase';
    ...
    public function save_purchase() {
        ...
        $account_data1 = array(
            ...
            'description' => 'Payment Invoice No: ' . $this->input->post('invoice_no'),
        ...
        $account_data2 = array(
            ...
            'description' => 'Payment Invoice No: ' . $this->input->post('invoice_no') . '' . $cheque_details,
            'txn_date' => date("Y-m-d", strtotime($this->input->post('purchase_date'))),
            'txn_type' => 'payment',
        ...
        redirect('transaction/payment-purchase', 'refresh');
    }

    public function edit_purchase($reference_no) {
        $data['title'] = 'Edit Payment Purchase';
        $data['company_name'] = $this->general->get_firm();
        ...
        $data['from_accounts'] = $this->general->get_this_or_that('account_reg', 'account_group', 'Bank Accounts', 'Loans & Liabilities');
        $data['main_content'] = 'godown_user/trans_pay_purchase_edit';
        $this->load->view('templates/standard', $data);
    }
