...
class Production_ctrlr extends CI_Controller {
...
//        }
        ...
        $data['main_content'] = 'godown_user/production';
...
//        }
        //$data['from_accounts'] = $this->general->get_data_wer('account_reg', 'account_group', 'Bank Accounts');
        $data['main_content'] = 'godown_user/trans_product_add';
        $this->load->view('templates/standard', $data);
    }
...
//            echo $inventory_update[0]->current_stock - $quantity[$i]; exit;
        ...
        redirect('transaction/production', 'refresh');
    }
...
//            $this->general->save('purchased_inventory', $data);
        ...
        redirect('transaction/production/product_add', 'refresh');
    }
