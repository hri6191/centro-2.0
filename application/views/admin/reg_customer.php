    ...
    <?php } else { ?>
        ...
        <div class="row">
            <div class="large-4 columns name-field">
                <label>Customer Name *
                    <input type="text" class="focus" name="customer_name" id="customer_name" value="<?php echo isset($edit_mode[0]->vendor_name) ? $edit_mode[0]->vendor_name : '' ?>" tabindex="1" required >
                </label>
