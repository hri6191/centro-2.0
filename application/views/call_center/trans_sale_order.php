...
<div class="row"></div>
<form action="<?php echo base_url(); ?>transaction/sale-order/save" method="post">
    <div class="row" style="background: #ECFAFF; border-radius: 10px; border: 1px solid; border-color: #B6EFFF;">
        ...
        <div class="large-3 columns">
            <label>Party
<!--                <a onclick="PopupCenter('<?php ///echo base_url() . "registration/real-customer";   ?>', 'Inventory', 400, 400);" href="javascript:void(0);" style="float: right;">NEW CUSTOMER?</a>-->
        ...
        <div class="large-3 columns">
            <label>District
                <input type="text" id="customer" required name="customer" tabindex="1" placeholder="Select District">
    ...
    <div class="large-12 small-12 columns" style="">
        ...
        <div class="row"><br/>
            <div class="large-2 columns name-field">
                <label>Discount
                    <input type="text" name="discount_all" tabindex="1" id="discount_all" onkeyup="disc_all_change()" >
                </label>
            </div>
            <div class="large-2 columns name-field">
                <label>Net Total
            ...
            <div class="large-8 columns name-field">
                <label>Remarks
                    <textarea name="remarks" placeholder="Enter Remarks..." tabindex="1"></textarea>
                </label>
            </div>
        </div>
        <div class="row" style="text-align: center;">
            <input type="submit" value="Save Sale Order" tabindex="1" class="button_zie button radius" id="save" onclick="return confirm('Are You Sure to Save?')">
        </div>
            <!--            <div class="large-2 columns name-field">
                            <label>Cash Received
        ...
        $("#jqxgrid").jqxGrid(
                {
                    ...
                    columns: [
                        ...
                        {text: 'Tax %', columngroup: 'CashDetails', editable: false, datafield: 'tax', width: '7%'},
