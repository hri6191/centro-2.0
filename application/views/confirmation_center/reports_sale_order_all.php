        ...
        var source =
                {
                    ...
                    url: '<?php echo base_url() . "confirmation_center/reports_sale_confirm_ctrlr/sale_order_data"; ?>',
                    cache: false
                };
        ...
        $("#jqxgrid").jqxGrid(
                {
                    ...
                    enabletooltips: true,
                    columns: [
                        {text: 'Party', datafield: 'party', cellclassname: cellclass, width: '20%'},
                        {text: 'Order By', datafield: 'user', cellclassname: cellclass, width: '20%'},
                        {text: 'Order Number', datafield: 'invoice_number', cellclassname: cellclass, width: '10%', cellsrenderer: function(row, cell, value) {
                                return '<a href="<?php echo base_url(); ?>reports/sale-order-all/invoice/' + value + '" />' + value + '</a>'
                            }},
                        ...
                        {text: 'Remarks', datafield: 'remarks', width: '20%', cellclassname: cellclass,},
                        {text: 'Sale Total', datafield: 'sale_total', filtertype: 'number', cellclassname: cellclass, aggregates: ['sum'], width: '20%'}
                    ]
                });
    });
</script>