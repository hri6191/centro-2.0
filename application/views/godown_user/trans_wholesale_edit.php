<div class="">
    <div class="large-12 small-12 columns" id="navigate">
        <ul class="breadcrumbs">
            ...
            <li class="current"><a href="#">WholeSale Edit</a></li>
        </ul>
    </div>
</div>
<div class="row"></div>
<form action="<?php echo base_url(); ?>transaction/wholesale/update" method="post">
        ...
        var source =
                {
                    ...
                    url: '<?php echo base_url() . "godown_user/Trans_wholesale_ctrlr/edit_sale_data?sale_id=" . $sale_id; ?>',
                    cache: false
                };
