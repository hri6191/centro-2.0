<div class="">
    <div class="large-12 small-12 columns" id="navigate">
            <ul class="breadcrumbs">
              ...
              <li class="current"><a >Tax Report</a></li>
            </ul>
    </div>
</div>
<div class="large-12 small-12 columns">
    <?php if($select_date1 == $select_date2) { ?>
    <h4>Tax Report as on <?php echo date("F j, Y", strtotime($select_date1)); ?></h4> <?php } else { ?>
    <h4>Tax Report From <?php echo date("F j, Y", strtotime($select_date1)); ?> to <?php echo date("F j, Y", strtotime($select_date2)); ?></h4><?php } ?>
</div>
<!--<div class="row">
...
$(document).ready(function () {
		...
		var source =
		{
			...
			url: '<?php echo base_url()."godown_user/Reports_tax_ctrlr/tax_data?txn_date1=".$select_date1."&txn_date2=".$select_date2; ?>',
			cache: false
		};
