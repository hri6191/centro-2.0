<div class="">
    <div class="large-12 small-12 columns" id="navigate">
        <ul class="breadcrumbs">
            ...
            <li class="current"><a href="#">Sale Return</a></li>
        </ul>
    </div>
</div>
<div class="row"></div>
<form action="<?php echo base_url(); ?>transaction/sale-return/save" method="post">
                    ...
                    columns: [
                        ...
                        {text: 'Total', columngroup: 'CashDetails', editable: false, datafield: 'total', width: '15%',
                            cellsrenderer: function(index, datafield, value, defaultvalue, column, rowdata) {
                                ...
                                return "<div style='margin: 4px;' class='jqx-right-align'>" + Math.round(total2) + "</div>";
                            },
                        }
                    ],
                    columngroups: [
