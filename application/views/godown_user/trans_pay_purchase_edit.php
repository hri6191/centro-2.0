<div class="">
    <div class="large-12 small-12 columns" id="navigate">
        <ul class="breadcrumbs">
            ...
            <li class="current"><a href="#">Payment Purchase Edit</a></li>
        </ul>
    </div>
</div>
<div class="row"></div>
<form action="<?php echo base_url(); ?>transaction/payment-purchase/update" method="post">
    ...
    <div class="large-12 small-12 columns" style="">
        ...
        <div class="large-12 columns"><br/>
            ...
            <div class="large-2 columns name-field">
                <input type="submit" value="Update Payment" tabindex="12" class="button_zie button radius" id="save" onclick="return confirm('Are You Sure to Update?')" style="float: right;">
            </div>
        </div>
        ...
        var source =
                {
                    ...
                    url: '<?php echo base_url() . "godown_user/Trans_pay_purchase_ctrlr/edit_purchase_data?purchase_id=" . $purchase_id; ?>',
                    cache: false
                };
