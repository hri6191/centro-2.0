...
<div class="">
    <div class="large-12 small-12 columns" id="navigate">
        <ul class="breadcrumbs">
            ...
            <li class="current"><a href="#">Interstate Sale</a></li>
        </ul>
    </div>
</div>
<div class="large-12 small-12 columns">
    <h4>Interstate Sale Report</h4>
</div>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        var source =
                {
                    ...
                    url: '<?php echo base_url() . "godown_user/Reports_i_sale_ctrlr/sale_data"; ?>',
                    cache: false
                };
        ...
        var linkrenderer = function (row, column, value) {
                    ...
                    var html = "<a href=\"<?php echo base_url(); ?>transaction/interstate-sale/edit/"+href+"\">"+value+"</a>";
                    return html;
                };
        ...
        $("#jqxgrid").jqxGrid(
                {
                    ...
                    columns: [
                        ...
                        {text: 'Invoice Number', datafield: 'InvoiceNumber', cellclassname: cellclass, width: '20%', cellsrenderer: function(row, cell, value) {
                                return '<a href="<?php echo base_url(); ?>reports/interstate-sale/invoice/' + value + '" />' + value + '</a>'
                            }},
