<div class="">
    <div class="large-12 small-12 columns" id="navigate">
        <ul class="breadcrumbs">
            <li><a href="<?php echo base_url(); ?>home?tab=txn">Home</a></li>
            <li><a href="<?php echo base_url(); ?>home?tab=txn">Transaction</a></li>
            <li class="current"><a href="#">Purchase Return</a></li>
        </ul>
    </div>
</div>
<div class="row"></div>
<form action="<?php echo base_url(); ?>transaction/purchase-return/save" method="post">
    ...
    <div class="large-2 columns">
        <label>Purchase Type
            <select id="purchase_type" tabindex="2" name="purchase_type" onchange="interex_change()" onkeyup="interex_change()" role="submit">
                <option value="1">VAT Dealer</option>
...
<div class="large-12 small-12 columns" style="">
    ...
    <div class="large-12 columns"><br/>
        ...
        <div class="large-2 columns name-field">
            <label>To Account
                <select name="from_account" tabindex="12">
        ...
        <div class="large-4 columns name-field">
            <input type="submit" value="Save Purchase Return" tabindex="12" class="button_zie button radius" id="save" onclick="return confirm('Are You Sure to Save?')" style="float: right;">
        </div>
    </div>
...
<script>
    ...
    function interex_keyup()
    {
        ...
        if($('#interex_amount').val() == '' ) interex_amount = 0;
        var summaryData = $("#jqxgrid").jqxGrid('getcolumnaggregateddata', 'total', ['sum']);
    ...
    function interex_keyup2()
    {
        ...
        if($('#interex_percentage').val() == '' ) interex_percentage = 0;
        var summaryData = $("#jqxgrid").jqxGrid('getcolumnaggregateddata', 'total', ['sum']);
        var net_total = summaryData.sum - $('#discount_all').val();
