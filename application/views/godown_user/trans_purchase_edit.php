<div class="">
    <div class="large-12 small-12 columns" id="navigate">
        <ul class="breadcrumbs">
            ...
            <li class="current"><a href="#">Purchase Edit</a></li>
        </ul>
    </div>
</div>
<div class="row"></div>
<form action="<?php echo base_url(); ?>transaction/purchase/update" method="post">
    ...
    <div class="" style="background: #ECFAFF; border-radius: 10px; border: 1px solid; border-color: #B6EFFF;">
        ...
        <div class="large-2 columns">
            <label>Vendor
                <input type="text" id="vendor" value="<?php echo $vendor[0]->vendor_name; ?>" name="vendor" tabindex="2" required placeholder="Select Vendor">
                <input type="hidden" id="vendor_selected" value="<?php echo $vendor[0]->id; ?>" name="vendor_id">
            </label>
        </div>
        <div class="large-2 columns">
            <label>Invoice Number
                <input type="text" name="invoice_no" id="invoice_no" value="<?php echo $invoice_number; ?>" tabindex="2" required />
            </label>
        </div>
        <div class="large-2 columns">
            <label>Purchase Date
                <input type="text" name="purchase_date"  id="purchase_date" readonly value="<?php echo $purchase_date; ?>" tabindex="2" />
            </label>
        </div>
        <div class="large-2 columns">
            <label>Stock Date
                <input type="text" name="stock_date"  id="stock_date" readonly value="<?php echo $stock_date; ?>" tabindex="2" />
            </label>
        </div>
        <div class="large-1 columns">
            <label>Type
                <select id="purchase_type" tabindex="2" name="purchase_type" onchange="interex_change()" onkeyup="interex_change()" role="submit">
                    <option value="1">Kerala(CGST & SGST)</option>
                    <option value="2">Interstate(IGST)</option>
        ...
        <div class="large-2 columns">
            <label>Description
                <input type="text" value="<?php echo $description; ?>" placeholder="Enter LR No or Courier No etc..." name="description"  id="description" tabindex="2" />
            </label>
        </div>
    </div>
    <hr>
    <div class="large-12 small-12 columns" style="">
        ...
        <div class="large-12 columns"><br/>
            <div class="large-2 columns name-field">
                <label>Discount
                    <input type="text" name="discount_all" value="<?php echo $discount_all; ?>" tabindex="12" id="discount_all" onkeyup="disc_all_change()" >
                </label>
            </div>
            <div class="large-2 columns name-field">
                <label>Net Total
                    <input type="text" name="net_total" value="<?php echo $purchase_total; ?>" tabindex="12" id="net_total" readonly >
                </label>
            </div>
            <div class="large-2 columns name-field">
                <label>Cash Paid
                    <input type="text" name="cash_paid" value="<?php echo $purchase_total; ?>" tabindex="12" id="cash_paid" >
                </label>
            </div>
            <div class="large-2 columns name-field">
                <label>From Account
            ...
            <div class="large-2 columns name-field">
                <input type="submit" value="Update Purchase" tabindex="12" class="button_zie button radius" id="save" onclick="return confirm('Are You Sure to Update?')" style="float: right;">
            </div>
        </div>
        ...
        var source =
                {
                    ...
                    url: '<?php echo base_url() . "godown_user/Trans_purchase_ctrlr/edit_purchase_data?purchase_id=" . $purchase_id; ?>',
                    cache: false
                };
