...
<div class="row">
    <div class="">
        <div class="large-12 small-12 columns name-field">
            <a href="<?php echo base_url() . 'transaction/purchase/delete?purchase_id=' . $purchase_id; ?>"><input type="button" value="Delete Purchase" class="button_zie button radius" id="delete_sale" onclick="return confirm('Are You Sure to Delete?')" style="float: left;"></a>
        </div>
    </div>
</div>
        ...
        var source =
                {
                    ...
                    url: '<?php echo base_url() . "godown_user/Reports_purchase_ctrlr/single_purchase_data?purchase_id=" . $purchase_id; ?>',
                    cache: false
                };
