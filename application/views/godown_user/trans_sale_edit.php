<div class="">
    <div class="large-12 small-12 columns" id="navigate">
        <ul class="breadcrumbs">
            ...
            <li class="current"><a href="#">Sale Edit</a></li>
        </ul>
    </div>
</div>
<div class="row"></div>
<form action="<?php echo base_url(); ?>transaction/sale/update" method="post">
    ...
    <div class="" style="background: #ECFAFF; border-radius: 10px; border: 1px solid; border-color: #B6EFFF;">
        <div class="large-1 columns name-field">
            <label>Invoice
                <input type="text" name="invoice_no" value="<?php echo $invoice_number; ?>" readonly id="invoice_no" >
            </label>
        </div>
        <input type="hidden" id="real_customer_selected" name="real_customer_id" value="1">
        <div class="large-2 columns">
            <label>Customer
                <input type="text" value="<?php echo $customer[0]->vendor_name; ?>" id="customer" name="customer" tabindex="1" placeholder="Select Customer">
                <input type="hidden" id="customer_selected" name="customer_id" value="<?php echo $customer[0]->id; ?>">
            </label>
        </div>
        <div class="large-2 columns">
            <label>Consignee
                <input type="text" id="real_customer" value="<?php echo $real_customer[0]->vendor_name; ?>" name="real_customer" tabindex="1" placeholder="Select Consignee">
                <input type="hidden" id="real_customer_selected" name="real_customer_id" value="<?php echo $real_customer[0]->id; ?>">
            </label>
        </div>
        <div class="large-2 columns">
            <label>Sale Date
                <input type="text" name="sale_date"  id="sale_date" value="<?php echo $sale_date; ?>" tabindex="1" />
            </label>
        </div>
        <div class="large-2 columns"> <!--  style="display: none;"--->
            <label>Del Note No&Date
                <input type="text" name="dc_no" value="<?php echo $dc_no; ?>"  id="dc_no" tabindex="1" />
            </label>
        </div>
        <div class="large-2 columns">
            <label>Sale Type
                <select id="sale_type" tabindex="1" name="sale_type" placeholder="Select Type" role="submit">
                    <option value="1" <?php if($sale_type == 1) echo 'selected'; ?>>Retail</option>
                    <option value="2" <?php if($sale_type == 2) echo 'selected'; ?>>Wholesale</option>
                    <option value="3" <?php if($sale_type == 3) echo 'selected'; ?>>Interstate</option>
                </select>
            </label>
        </div>
        <div class="large-1 columns"> <!--  style="display: none;"--->
            <label>Vehicle No
                <input type="text" name="vehicle_no" value="<?php echo $vehicle_no; ?>"  id="vehicle_no" tabindex="1" />
            </label>
        </div>
        <div class="row">
            <input type="text" name="description" value="<?php echo $description; ?>" id="description" placeholder="Enter Purchase order no, Site address etc..." />
        </div>
    </div>
    <hr>
    <div class="large-12 small-12 columns" style="">
        ...
        <div class="row"><br/>
            ...
            <div class="large-2 columns name-field">
                <label>Net Total
                    <input type="text" name="net_total" tabindex="" id="net_total" readonly >
                        ...
                        <div class="large-2 columns name-field">
                            <label>Cash Received
                                <input type="text" name="cash_paid" value="<?php echo $cash_paid; ?>" tabindex="" id="cash_paid" >
                            </label>
                        </div>
                        <div class="large-2 columns name-field">
                            <label>To Account
            ...
            <div class="large-4 columns name-field">
                <input type="submit" value="Update" tabindex="1" class="button_zie button radius" id="save" onclick="return confirm('Are You Sure to Save?')" style="float: right;">
            </div>
        </div>
        ...
        var source =
                {
                    ...
                    url: '<?php echo base_url() . "godown_user/Trans_sale_ctrlr/edit_sale_data?sale_id=" . $sale_id; ?>',
                    cache: false
                };
