...
<form action="<?php echo base_url(); ?>reports/sale/create-pdf" method="post">
    <div class="row" style="background: #ECFAFF; border-radius: 10px; border: 1px solid; border-color: #B6EFFF;">
        ...
        <div class="large-2 columns" style="display: none;">
            <label>School
                <input type="text" name="real_customer_id"  id="real_customer_id" readonly value="<?php echo $school; ?>" />
                <input type="text" name="sale_type"  id="sale_type" readonly value="<?php echo $sale_type; ?>" />
            </label>
        </div>
...
$(document).ready(function () {
		...
		var source =
		{
			...
			url: '<?php echo base_url()."godown_user/Reports_sale_ctrlr/single_sale_data?sale_id=".$sale_id; ?>',
			cache: false
		};
