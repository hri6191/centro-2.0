...
<input type="button" style="margin: 10px;" value="Export to Json" id='jsonExport' class="button tiny" />
</div>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        var source =
                {
                    ...
                    url: '<?php echo base_url() . "godown_user/Reports_sale_ctrlr/sale_data"; ?>',
                    cache: false
                };
        ...
        var linkrenderer = function (row, column, value) {
                    ...
                    var html = "<a href=\"<?php echo base_url(); ?>transaction/sale/edit/"+href+"\">"+value+"</a>";
                    return html;
                };
        ...
        $("#jqxgrid").jqxGrid(
                {
                    ...
                    enabletooltips: true,
                    columns: [
                        {text: 'Customer', datafield: 'Customer', cellclassname: cellclass, width: '20%'},
                        ...
                        {text: 'Sale Date', datafield: 'SaleDate', filtertype: 'date', cellclassname: cellclass, width: '10%'},
                        {text: 'Status', datafield: 'Status', hidden: true, width: '25%'},
                        {text: 'Sale Total', datafield: 'SaleTotal', filtertype: 'number', cellclassname: cellclass, aggregates: ['sum'], width: '20%', cellsalign: 'right'},
                        {text: 'Description', datafield: 'Description', cellclassname: cellclass, width: '15%'},
