...
<div class="large-12 small-12 columns" id="navigate">
    <h4>Select Date</h4>
    <div class="row">
            <form action="<?php echo base_url(); ?>reports/gst-report" name="for_edit" id="for_edit" method="post">
                ...
                <div class="large-4 columns">
                    <input type="submit" value="SUBMIT" class="tiny button" style="background: #d90d0d;">
                </div>
            </form>
    </div>
    <hr>
    <h4><u>GSTR1 [HSN] DOWNLOAD</u></h4><br/>
    <div class="row">
        <form action="<?php echo base_url(); ?>reports/gst-upload" name="for_edit" enctype="multipart/form-data" id="for_edit" method="post">
