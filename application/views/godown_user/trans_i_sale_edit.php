<div class="">
    <div class="large-12 small-12 columns" id="navigate">
        <ul class="breadcrumbs">
            ...
            <li class="current"><a href="#">Interstate Sale Edit</a></li>
        </ul>
    </div>
</div>
<div class="row"></div>
<form action="<?php echo base_url(); ?>transaction/interstate-sale/update" method="post">
    ...
    <div class="row" style="background: #ECFAFF; border-radius: 10px; border: 1px solid; border-color: #B6EFFF;">
        ...
        <div class="large-4 columns">
            <label>Customer
                <input type="text" value="<?php echo $customer[0]->vendor_name; ?>" id="customer" required name="customer" tabindex="1" placeholder="Select Customer">
        ...
        var source =
                {
                    ...
                    url: '<?php echo base_url() . "godown_user/Trans_i_sale_ctrlr/edit_sale_data?sale_id=" . $sale_id; ?>',
                    cache: false
                };
