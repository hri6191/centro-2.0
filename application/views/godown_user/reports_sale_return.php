...
<div class="">
    <div class="large-12 small-12 columns" id="navigate">
        <ul class="breadcrumbs">
            ...
            <li class="current"><a href="#">Sales Return</a></li>
        </ul>
    </div>
</div>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        var source =
                {
                    ...
                    url: '<?php echo base_url() . "godown_user/Reports_sale_ctrlr/sale_return_data"; ?>',
                    cache: false
                };
        ...
        var linkrenderer = function (row, column, value) {
                    ...
                    var html = "<a href=\"<?php echo base_url(); ?>transaction/sale-return/edit/"+href+"\">"+value+"</a>";
                    return html;
                };
        ...
        $("#jqxgrid").jqxGrid(
                {
                    ...
                    columns: [
                        ...
                        {text: 'Invoice Number', datafield: 'InvoiceNumber', cellclassname: cellclass, width: '20%', cellsrenderer: function(row, cell, value) {
                                return '<a href="<?php echo base_url(); ?>reports/sale-return/invoice/' + value + '" />' + value + '</a>'
                            }},
