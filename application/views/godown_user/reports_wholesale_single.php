<div class="">
    <div class="large-12 small-12 columns" id="navigate">
            <ul class="breadcrumbs">
              ...
              <li class="current"><a href="#">Single WholeSale</a></li>
            </ul>
    </div>
</div>
<form action="<?php echo base_url(); ?>reports/wholesale/create-pdf" method="post">
    ...
    <div class="row">
        <div class="">
            <div class="large-12 small-12 columns name-field">
                <a href="<?php echo base_url().'transaction/wholesale/delete?sale_id='.$sale_id; ?>"><input type="button" value="Delete Sale" class="button_zie button radius" id="delete_sale" onclick="return confirm('Are You Sure to Delete?')" style="float: left;"></a>  
...
$(document).ready(function () {
		...
		var source =
		{
			...
			url: '<?php echo base_url()."godown_user/Reports_wholesale_ctrlr/single_sale_data?sale_id=".$sale_id; ?>',
			cache: false
		};
