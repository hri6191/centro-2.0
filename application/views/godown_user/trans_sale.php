...
<div class="row"></div>
<form action="<?php echo base_url(); ?>transaction/sale/save" method="post">
    <div class="" style="background: #ECFAFF; border-radius: 10px; border: 1px solid; border-color: #B6EFFF;">
        ...
        <div class="large-2 columns">
            <label>Customer
                <input type="text" id="customer" name="customer" value="Cash" tabindex="1" placeholder="Select Customer">
                <input type="hidden" id="customer_selected" name="customer_id" value="1">
            </label>
        </div>
        <div class="large-2 columns">
            <label>Consignee
                <input type="text" id="real_customer" name="real_customer" tabindex="1" placeholder="Select Consignee">
                <input type="hidden" id="real_customer_selected" name="real_customer_id" value="2">
            </label>
        </div>
        ...
        <div class="large-2 columns">
            <label>Sale Type
                <select id="sale_type" tabindex="1" name="sale_type" placeholder="Select Type" role="submit">
                    ...
                    <option value="3">Interstate</option>
                </select>
            </label>
        </div>
        ...
        <div class="row">
            <input type="text" name="description" id="description" placeholder="Enter Purchase order no, Site address etc..." />
        </div>
    </div>
    <hr>
