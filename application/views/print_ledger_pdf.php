...
<tr><td></td><td colspan="7"><h2>REPORT:</h2></td></tr>
...
<?php 
    ...
    for ($i=0; $i < $n; $i++) { ?>
        ...
        <td style="text-align: right; border-right-style: none;"><?php echo $narration[$i]; ?></td>
        <td class="change_order_unit_col" style="border-left-style: none;"></td>
        <td style="text-align: center"><?php echo $debit[$i]; ?></td>
...
<td colspan="2" style="text-align: right;"><strong>BALANCE: Rs. <?php echo $balance_sum[0]; ?>/-</strong></td>
<td colspan="1" style="text-align: right;"><strong>Rs. <?php echo $debit_sum[0]; ?>/-</strong></td>
<td class="change_order_total_col"><strong>Rs. <?php echo $credit_sum[0]; ?>/-</strong></td></tr>
</table>
