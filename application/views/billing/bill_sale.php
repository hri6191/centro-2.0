...
<div class="row"></div>
<form action="<?php echo base_url(); ?>billing/sale/save" method="post">
    <div class="row" style="background: #ECFAFF; border-radius: 10px; border: 1px solid; border-color: #B6EFFF;">
        ...
        <div class="large-4 columns">
            <label>Customer
                <input type="text" id="customer" name="customer" tabindex="1" placeholder="Select Customer">
    ...
    <div class="large-12 small-12 columns" style="">
        <div class="row" style="background: #E8E8E8; border-right: 1px solid; border-color: #C7C7C7;">
            <div class="large-5 columns">
                <label>Item
                    <input type="text" class="focus" id="item_name" name="item_name" tabindex="1" placeholder="Type Name/Code">
                </label>
            </div>
